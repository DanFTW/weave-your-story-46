import { Loader2, Linkedin, Zap } from "lucide-react";

export function ActivatingScreen() {
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      <div className="relative mb-8">
        <div className="w-24 h-24 rounded-full bg-[#0A66C2]/10 flex items-center justify-center">
      ...
      <h2 className="text-xl font-bold text-foreground mb-2 text-center">
        Activating LinkedIn Monitoring
      </h2>
      
      <p className="text-muted-foreground text-center max-w-xs">
        Setting up background sync for your new connections...
      </p>
    </div>
  );
}
