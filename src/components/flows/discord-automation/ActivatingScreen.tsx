  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      <div className="relative mb-8">
        <div className="w-24 h-24 rounded-full bg-[#5865F2]/10 flex items-center justify-center">
      ...
      <Loader2 className="w-8 h-8 text-[#5865F2] animate-spin mb-6" />

      <h2 className="text-xl font-bold text-foreground mb-2 text-center">
        Activating Discord Monitoring
      </h2>

      <p className="text-muted-foreground text-center max-w-xs">
        Setting up real-time message tracking for your Discord channel...
      </p>
    </div>
  );
}
