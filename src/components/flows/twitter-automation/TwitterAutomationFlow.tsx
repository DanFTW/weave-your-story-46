...
import { useTwitterAutomation } from "@/hooks/useTwitterAutomation";
...
export function TwitterAutomationFlow() {
  ...
  const getSubtitle = () => {
    switch (phase) {
      ...
      case 'active':
        return 'Monitoring your Twitter activity';
      default:
        return 'Automatically capture Twitter moments';
    }
  };
      ...
      <div className={cn("relative px-5 pt-status-bar pb-6", gradientClasses.blue)}>
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-xl font-bold text-white truncate">Twitter Live</h1>
