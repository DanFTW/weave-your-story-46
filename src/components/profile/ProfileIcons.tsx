// Profile settings icons matching the reference design

export function MailIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="2" y="4" width="20" height="16" rx="3" stroke="currentColor" strokeWidth="2"/>
      <path d="M2 7L10.165 12.7143C11.2619 13.4654 12.7381 13.4654 13.835 12.7143L22 7" stroke="currentColor" strokeWidth="2"/>
    </svg>
  );
}
