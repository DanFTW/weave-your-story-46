...
const mainThreads: Thread[] = [
  ...
  },
  {
    ...
    description: "Parse purchase confirmation emails and track expenses in a Google Sheet automatically",
    icon: Receipt,
    gradient: "teal",
    status: "active",
    type: "automation",
  ...
  },
  {
    ...
    description: "Discover personalized local events based on your interests and location, delivered on a recurring schedule",
    icon: Calendar,
    gradient: "purple",
    status: "active",
    type: "automation",
  ...
  },
  {
    ...
    description: "Scan Gmail for receipts and invoices, save purchases as memories",
    icon: Receipt,
    gradient: "teal",
    status: "active",
    type: "automation",
...
// Threads placed at the bottom of the list
...
export const sampleThreads: Thread[] = [...mainThreads, ...bottomThreads];
