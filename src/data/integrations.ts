...
export const integrationDetails: Record<string, IntegrationDetail> = {
  ...
  "googlephotos": {
    ...
    icon: "googlephotos",
    status: "none",
    description: "Google Photos allows Weave to access your photo library and albums. Create memories automatically from your captured moments and relive your visual journey.",
