...
const EVENT_KEYWORDS =
  /\b(meeting|appointment|deadline|party|dinner|lunch|breakfast|brunch|call|interview|concert|conference|workshop|webinar|session|reservation|flight|check-?in|standup|stand-up|sync|review|demo|presentation|birthday|anniversary|wedding|exam|class|lecture)\b/i;
